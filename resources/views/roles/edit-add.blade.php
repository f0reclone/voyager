...
@section('page_title', __('voyager::generic.'.(isset($dataTypeContent->id) ? 'edit' : 'add'), ['name' => $dataType->display_name_singular]))
...
@section('page_header')
    <h1 class="page-title">
        ...
        {{ __('voyager::generic.'.(isset($dataTypeContent->id) ? 'edit' : 'add'), ['name' => $dataType->display_name_singular] }}
    </h1>
@stop
